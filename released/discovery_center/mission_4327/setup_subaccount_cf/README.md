...
4. Change the variables in the samples.tfvars file to meet your requirements(By default free-tier plans are used, if you want to use it for production update in the samples.tfvars accordingly)
