...
const HEADERS_TO_MASK = ['x-approuter-authorization','authorization', 'cookie', 'set-cookie', 'proxy-authorization', 'sap-connectivity-authentication', 'x-ias-token', 'x-forwarded-client-cert'];
const PARAMETERS_TO_MASK = ['code', 'password'];
