...
const escape = require('base64-url').escape;
...
Tokens.prototype.create = function create(secret) {
  ...
  return this._tokenize(secret, generateSalt(this.saltLength));
};
...
/*
 Tokens.prototype.generateSalt = function generateSalt(saltLength) {
 return crypto.randomBytes(Math.ceil(saltLength))
 .toString('hex');
 };
