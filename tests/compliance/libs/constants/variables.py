...
QAS_STEP2_CF_PROVIDER_MANDATORY_VARIABLES = ["cf_api_url", "cf_landscape_label", "cf_org_id", "cf_org_name", "subaccount_id"]

# BTP_PROVIDER_MANDATORY_RESOURCES = ["btp_subaccount", "btp_subaccount_trust_configuration"]
